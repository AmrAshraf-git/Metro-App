private val FIRST_LINE = listOf("Helwan", "Ain Helwan", "Helwan University", "Wadi Hof", "Hadayek Helwan", "El-Masra", "Tura El-Esmant", "Kozzika", "Tura El-Balad", "Sakanat El-Maadi", "Hadayek El-Maadi", "Dar El-Salam", "El-Zahraa", "Mar Girgis", "El-Malek El-Saleh", "El-Sayeda Zeinab", "Saad Zaghloul", "Sadat (Tahrir)", "Gamal Abdel Nasser", "Ahmad Orabi", "El-Shohadaa (Ramses)", "Ghamra", "Demerdash", "Manshiet El-Sadr", "Kobri El-Qobba", "Hammamat El-Qobba", "Saray El-Qobba", "Hadayek El-Zaiton", "Helmeyet El-Zaiton", "El-Matareyya", "Ain Shams", "Ezbet El-Nakhl", "El-Marg", "El-Marg El-Gadidah")
private val SECOND_LINE = listOf("El-Mounib", "Sakiat Mekky", "Um El-Masryeen", "Giza", "Faisal", "Cairo University", "Al-Bohouth", "Dokki", "Opera", "Sadat (Tahrir)", "Mohammad Naguib", "Attaba", "El-Shohadaa (Ramses)", "Masarra", "Rod El-Farag", "St. Teresa", "El-Khalfawy", "Mezallat", "Koliat El-Zeraa", "Shubra El-Khaima")
private val THIRD_LINE = listOf("Adly Mansour", "Haykestep", "Omar Ibn El Khattab", "Qubaa", "Hesham Barakat", "El Nozha", "El Shams Club", "Alf Masken", "Heliopolis", "Haroun", "Al-Ahram", "Koleyet El-Banat", "Stadium", "Abbassiya", "Fair Zone", "Abdou Pasha", "El-Geish", "Bab El Shaariya", "Attaba", "Gamal Abdel Nasser", "Maspero", "Safaa Hijazy", "Kit-Kat", "Sudan", "Imbaba", "El-Bohy", "El-Qawmia", "Ring Road", "Rod El Farag", "Tawfikia", "Wadi El Nile", "Gamet El Dowal", "Boulak El Dakrour", "Cairo University")

fun main() {

    val cairoMetro = mapOf(
        "Line 1" to FIRST_LINE,
        "Line 2" to SECOND_LINE,
        "Line 3" to THIRD_LINE
    )
    ...
    val startLine = findLine(cairoMetro, startStation)
    val arrivalLine = findLine(cairoMetro, arrivalStation)
    ...
    val lineStations = cairoMetro[startLine]!!
